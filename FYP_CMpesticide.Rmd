...
# PERMANOVA and PCA pairwise comparisons
```{r}
adonis(agri.physiology[,c(1:3)] ~ Site, data = agri.physiology.level)

# Create dissimilarity matrix
dis <- vegdist(agri.physiology[,c(1:3)])
adonis.pair(dis,agri.physiology.level$Site)
# Check for non-equal dispersions using betadisper() and permutest()
dispersion_model <- betadisper(dis, agri.physiology.level$Site)
